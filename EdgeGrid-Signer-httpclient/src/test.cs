...
namespace Akamai
{
    public class test
    {
        ...
        Akamai.EdgeGrid.EdgeGridSigner testPost = new Akamai.EdgeGrid.EdgeGridSigner();
        ...
        Akamai.EdgeGrid.EdgeGridSigner test = new Akamai.EdgeGrid.EdgeGridSigner();
        ...
        Akamai.EdgeGrid.EdgeGridSigner test2 = new Akamai.EdgeGrid.EdgeGridSigner(HttpMethod.Get,requestUrl);
        test2.getCredentialsFromEnvironment();
        Task request2 = testRequest(test);
        request2.Wait();


        Akamai.EdgeGrid.EdgeGridSigner test3 = new Akamai.EdgeGrid.EdgeGridSigner(HttpMethod.Get,requestUrl);
        ...
        private static async Task<string> testRequest(Akamai.EdgeGrid.EdgeGridSigner AuthHeader) {
            string sresponse =string.Empty;
            try{
